...
Tags: Disable Comments, Stop Spam, Delete Comments, Remove Comments, Comments
...
Run `wp help disable-comments settings` for the full list of options. [Full WP-CLI documentation](https://wpdeveloper.com/docs/how-to-use-disable-comments-plugin-with-wp-cli-command-line/).
...
= 2.8.0 =
Fixes cached pages continuing to serve the comment form after comments were disabled. Adds WordPress Abilities API support (WP 6.9+) so AI assistants and MCP clients can read your comment settings. Compatible with WordPress 7.0.
